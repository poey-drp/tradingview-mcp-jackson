...
5. **ตาราง probability:** **Entry**, TP1, TP2, TP3, SL — ราคาเป๊ะ + ระยะ + % โอกาสแตะ + R:R + **ETA (จำนวนแท่ง + เวลาโดยประมาณ)** + **time-stop (เส้นตายเป็นจำนวนแท่ง)**
   - **แถวแรกต้องเป็น Entry เสมอ** (entry zone ราคาเป๊ะ; ช่อง ระยะ/%/R:R/ETA ใส่ `—`) — ใช้ราคากลางโซน entry เป็นฐานคำนวณระยะของ TP/SL ทุกตัว
